...
class BiLSTMCRF(nn.Module):
    ...
    def __build_features(self, sentences):
        ...
        #lstm_feats = self.hidden2tag(packed_output)
        lstm_out, _ = pad_packed_sequence(packed_output, batch_first=True, total_length=self.tagset_size)
